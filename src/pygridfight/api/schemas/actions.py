...
class AttackAction(BaseAction):
    ...
    weapon_id: Optional[str] = Field(None, description="Weapon to use for attack")
...
class CollectAction(BaseAction):
    ...
    target_position: Position = Field(..., description="Position of resource to collect")
...
class UseItemAction(BaseAction):
    ...
    target_position: Optional[Position] = Field(None, description="Target position for item use")
